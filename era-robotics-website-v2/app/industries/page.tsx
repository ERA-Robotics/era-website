...
const industries = [
  ...
  },
  {
    ...
    body:
      "Autonomous cleaning robotics for private hospitals and aged care facilities where safety, consistency and low-disruption operation are essential.",
    priorities: [
      "Safety-conscious operation around patients, residents and staff",
      "Consistent floor-cleaning standards",
      "Reliable coverage across corridors and shared areas",
      "Low-disruption operation in occupied environments",
    ],
    capabilities: [
      "Autonomous corridor and public-area cleaning",
      "Scrubbing and floor-care workflows",
      "Site-specific mapping and route configuration",
